...
const Mimos = () => {
    const phrases = [
        ...
        // --- Novas Frases Baseadas nos Amigos (DataService) ---

        // Tema: Dança e Leveza (Baseado na Julia, Thiago e Nicole)
        {
            text: 'Sua leveza ao dançar encanta minha alma.',
            emoji: '🩰',
            color: 'from-pink-300 to-rose-300',
        },
        {
            text: 'Você é poesia em movimento, minha bailarina.',
            emoji: '💃',
            color: 'from-purple-300 to-pink-400',
        },

        // Tema: Fé e Espiritualidade (Baseado no Moih, Tirza e Lokkas)
        {
            text: 'Você reflete o coração de Deus em tudo o que faz.',
            emoji: '🙏',
            color: 'from-blue-300 to-cyan-400',
        },
        {
            text: 'Agradeço ao Papai do Céu todos os dias por você.',
            emoji: '🙌',
            color: 'from-sky-400 to-blue-500',
        },
        {
            text: 'Sua vida é uma resposta de oração para mim.',
            emoji: '🕊️',
            color: 'from-teal-300 to-emerald-400',
        },

        // Tema: Personalidade e Carisma (Baseado na Ana Luiza, Pedro e Vitória)
        {
            text: 'Sua risada contagiante é a melhor música.',
            emoji: '🎶',
            color: 'from-yellow-300 to-orange-300',
        },
        {
            text: 'Você é luz e carisma por onde passa.',
            emoji: '🌟',
            color: 'from-amber-300 to-yellow-500',
        },
        {
            text: 'Meu abraço em forma de gente.',
            emoji: '🫂',
            color: 'from-rose-300 to-pink-300',
        },
        {
            text: 'Doce, meiga e incrivelmente forte.',
            emoji: '💪',
            color: 'from-fuchsia-400 to-pink-500',
        },

        // Tema: Futuro e Parceria (Baseado na Tirza e Lokkas)
        {
            text: 'Quero colecionar momentos incríveis com você.',
            emoji: '📸',
            color: 'from-indigo-400 to-purple-500',
        },
        {
            text: 'Minha melhor amiga e meu amor.',
            emoji: '👩‍❤️‍👨',
    ...
    const generateNewPhrase = () => {
        let newIndex;
        // Garante que não repete as últimas frases para dar variedade
        do {
        ...
        setPreviousIndexes((prev) => {
            ...
            // Aumentei o histórico para 5 para evitar repetições frequentes já que a lista cresceu
